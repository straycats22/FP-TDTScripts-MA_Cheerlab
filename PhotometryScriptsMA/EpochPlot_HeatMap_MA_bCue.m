...
% Add data
clear all; clc;
data = TDTbin2mat('D:\PhD\CheerLab\WIN88-EXT26_WIN75-REINST', 'TYPE', {'epocs', 'scalars', 'streams'});

%% Remove Last reward Value  
% data.epocs.bRP_.onset(end)=[];
% data.epocs.bRP_.offset(end)=[];
% data.epocs.bRP_.data(end)=[];
% data.epocs.bRP_.onset(1)=[];
% data.epocs.bRP_.offset(1)=[];
% data.epocs.bRP_.data(1)=[];
